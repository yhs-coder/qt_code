...
class ProtocolData final :
 ...
 public:
  ...
  void set_caplen(uint32_t value);
  private:
  uint32_t _internal_caplen() const;
  void _internal_set_caplen(uint32_t value);
  public:
...
// string time = 10;
inline void ProtocolData::clear_time() {
  _impl_.time_.ClearToEmpty();
}
inline const std::string& ProtocolData::time() const {
  // @@protoc_insertion_point(field_get:Protocol.ProtocolData.time)
  return _internal_time();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ProtocolData::set_time(ArgT0&& arg0, ArgT... args) {
 
 _impl_.time_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Protocol.ProtocolData.time)
}
inline std::string* ProtocolData::mutable_time() {
  std::string* _s = _internal_mutable_time();
  // @@protoc_insertion_point(field_mutable:Protocol.ProtocolData.time)
  return _s;
}
inline const std::string& ProtocolData::_internal_time() const {
  return _impl_.time_.Get();
}
inline void ProtocolData::_internal_set_time(const std::string& value) {
  
  _impl_.time_.Set(value, GetArenaForAllocation());
}
inline std::string* ProtocolData::_internal_mutable_time() {
  
  return _impl_.time_.Mutable(GetArenaForAllocation());
}
inline std::string* ProtocolData::release_time() {
  // @@protoc_insertion_point(field_release:Protocol.ProtocolData.time)
  return _impl_.time_.Release();
}
inline void ProtocolData::set_allocated_time(std::string* time) {
  if (time != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:Protocol.ProtocolData.time)
}

// uint32 caplen = 11;
inline void ProtocolData::clear_caplen() {
  _impl_.caplen_ = 0u;
}
inline uint32_t ProtocolData::_internal_caplen() const {
  return _impl_.caplen_;
}
inline uint32_t ProtocolData::caplen() const {
  // @@protoc_insertion_point(field_get:Protocol.ProtocolData.caplen)
  return _internal_caplen();
}
inline void ProtocolData::_internal_set_caplen(uint32_t value) {
  
  _impl_.caplen_ = value;
}
inline void ProtocolData::set_caplen(uint32_t value) {
  _internal_set_caplen(value);
  // @@protoc_insertion_point(field_set:Protocol.ProtocolData.caplen)
}
